...
public class MySqlProfileDao extends MySqlDaoBase implements ProfileDao
{
    ...
    public void updateUser(Profile profile) {
        ...
        try (Connection connection = getConnection();
             ...
             setPreparedStatement(ps, profile);
    ...
    //Helper method to map PreparedStatement
    private void setPreparedStatement(PreparedStatement ps, Profile profile) throws SQLException {
